package com.leightek.beserver;

import com.leightek.beserver.enumeration.Status;
...
public class BeserverApplication {

	public static void main(String[] args) {
		SpringApplication.run(BeserverApplication.class, args);
	}

	@Bean
	CommandLineRunner run(ServerRepository serverRepository) {
		return args -> {
			serverRepository.save(new Server(null, "192.168.1.168", "Ubuntu Linux", "16 GB", "Personal PC",
